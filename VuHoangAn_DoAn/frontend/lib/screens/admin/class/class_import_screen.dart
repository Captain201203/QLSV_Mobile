...
class ClassImportScreen extends StatefulWidget {
  const ClassImportScreen({super.key});

  @override
  State<ClassImportScreen> createState() => _ClassImportScreenState();

}

class _ClassImportScreenState extends State<ClassImportScreen>{
  ...
  Future<void> _uploadFile() async{
    ...
    try{
      final result = await ClassImportService.importFromExcel(_selectedFile!);
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Import lớp từ Excel'),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('1. File Excel phải có các cột: classId, className, department'),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildResultRow('Lỗi', _importResult!['errors']?.length?.toString() ?? '0'),
